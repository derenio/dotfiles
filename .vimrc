...
augroup my_file_types
	au!
	au FileType json,coffee,typescript,css,less,jade,pug setlocal ts=4 | setlocal sw=4 | setlocal sts=4 | setlocal et
	...
	au FileType ruby,*html*,javascript setlocal ts=2 | setlocal sw=2 | setlocal sts=2 | setlocal et
...
" E501 - line length
let g:syntastic_python_flake8_args='--max-line-length=120 --ignore=E226,D100,D101,D102,D103,D104,D105,D200,D202,D205,D208,D209,D400,D401'
